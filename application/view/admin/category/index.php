...
?>
                ...
                <section class="panel">
                    <header class="panel-heading">
                        <a class="btn btn-outline-dark" href="<?php $this->url('category/create') ?>">افزودن دسته </a>
                    ...
                    <table class="table table-striped table-advance table-hover">
                        ...
                        <tr>
                            ...
                            <td><a href="<?php $this->url('category/edit/'.$cat->id); ?>" class="btn btn-primary btn-xs">
                            ...
                            <td><a href="<?php $this->url('category/destroy/'.$cat->id); ?>" class="btn btn-danger btn-xs">
