    ...
    <div class="admin-menu">
        <ul>
            ...
            <ul class="sub-category">
                ...
                <li><a href="<?php $this->url('category/create'); ?>">افزودن دسته</a></li>
            </ul>
            ...
            <ul class="sub-article">
                <li><a href="<?php $this->url('post/index'); ?>">همه نوشته ها</a></li>
                <li><a href="<?php $this->url('post/create'); ?>">افزودن نوشته</a></li>
            </ul>
            ...
            <ul class="sub-product">
                <li><a href="<?php $this->url('products/index'); ?>">همه محصولات</a></li>
                <li><a href="<?php $this->url('products/create'); ?>">افزودن محصول</a></li>
            </ul>
